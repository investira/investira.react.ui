const currency = {
    currencyToNumber: (pValue, pSeparator = '.', pDecimal) => {
        ...
        let xValue = currency.addDecimalToNumber(xDigitsWithPadding, pSeparator, pDecimal);
        return xValue;
    },
    ...
    toCurrency: (pValue, pSeparator = '.', pCurrency = 'BRL', pLocale = 'pt-BR', pDecimal) => {
    ...
    toDecimal: (pValue, pDecimal, _pLocale = 'pt-BR', pSeparator = ',') => {
        let xValue = currency.currencyToNumber(pValue, pSeparator, pDecimal);
