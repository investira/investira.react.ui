import { baseTheme as base } from '../styles/baseTheme';

export function capitalize(string) {
    if (process.env.NODE_ENV !== 'production' && typeof string !== 'string') {
        throw new Error('InvestiraReact: capitalize(string) expects a string argument.');
    }
...
export const getColor = pPathString => {
    ...
    if (xStrSize < 2) {
        return base.colors.common.black;
    }

    return resolvePath(base.colors, pPathString, base.colors.error.main);
};
